...
<tr>
    <td style="padding: 5px;">
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    {{-- <p style="font-size:14px; font-weight:500; text-align:left;color:#4a4a4a;"><span style="font-weight:500; font-size:15px;">Login Here:</span> <a href="{{$data['url']}}" style="text-decoration:none; cursor:pointer;">Duvaiship Admin Portal</a></p> --}}
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Email:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['email']}}</span></p>
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Generated Password:</span> {{$data['password']}}</p>
                </td>
            </tr>
        </table>
    </td>
