        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Your contribution for group [{{$data['contribution_title']}}] has been confirmed.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">We want to let you know your contribution has been received for this cycle of this scheme. </p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Below is the full details for your contribution.</p>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td style="padding: 5px;">
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Contributor Name:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['name']}}</span></p>
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Contributor Email:</span> {{$data['email']}}</p>
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Payment Date:</span> {{$data['date']}}</p>
                </td>
                <td style="padding: 0 22px">
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Group Title:</span> {{$data['contribution_title']}}</p>
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Amount Contributed:</span> GHS.{{$data['amount']}}</p>
