        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">You are attempting to reset your password .</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Please use the code provided below to complete your password reset.</p>
                </td>
            </tr>
        </table>
    </td>
        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Password Reset Code:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['code']}}</span></p>
                </td>
            </tr>
        </table>
    </td>
