        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    <p style="font-size:20px; text-align:left;font-weight:500; color:#4a4a4a;margin-bottom:10px ">Hello {{ $data['user_name'] }} !</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; "> You have received an invite for a P2P Group on stacksinvestment.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Please use the button below to review all your pending invites and respond accordingly.</p>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td style="padding: 5px;">
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Email:</span> {{$data['email']}}</p>
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Phone Number:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['user_phone']}}</span></p>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td style="padding: 30px; display: flex; justify-content: center; text-align: center;">
        <a href="{{ $data['link'] }}" style="text-decoration: none; cursor: pointer; background: #e85d04; padding: 15px 30px; color: #fff; font-weight: 700; font-size: 20px; border: 2px solid #fff; margin: 0 auto; display: inline-block;">VIEW INVITES</a>
    </td>
</tr>
