        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">This email is to inform you that the stack-investment-hub team have reviewed and approved the details of your crowdfunding project.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">We hope to help you achieve your dreams using out platform as a helping tool for soliciting funds.</p>
