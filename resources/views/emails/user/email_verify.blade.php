        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Verification Code:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['code']}}</span></p>
                </td>
            </tr>
        </table>
    </td>
