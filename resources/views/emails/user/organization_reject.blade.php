        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Thank you for using stacks-investment-hub for your P2P Organization.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">This email is to inform you that the stack-investment-hub team have rejected your P2P Organization.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">{{$reason}}.</p>
