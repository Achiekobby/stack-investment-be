        ...
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    ...
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Your donation has been confirmed. We thank you for taking your time to make this donation for this campaign.</p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">We want to let you know your help is duly appreciated. </p>
                    <p style="font-size:14px; text-align:left; font-weight:500; color:#4a4a4a; line-height:1.6rem; ">Below is the full details for your donation.</p>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td style="padding: 5px;">
        <table width="100%">
            <tr>
                <td style="padding: 0 22px">
                    <p style="font-size:14px; font-weight:500; color:#4a4a4a; text-align:left;"><span style="font-weight:500; font-size:15px;">Donor Name:</span> <span style="color:#4a4a4a; font-weight:700;font-size:15px;">{{$data['name']}}</span></p>
